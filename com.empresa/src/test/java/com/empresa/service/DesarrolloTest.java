...
class DesarrolloTest {
    ...
    @Test
    void shouldNotDespedirGerenteConEquipoValido() {
        Empresa empresa = new Empresa(10000);
        Finanzas finanzas = new Finanzas();
        RecursosHumanos rh = new RecursosHumanos(empresa, finanzas);

        Desarrollador desarrollador1 = new Desarrollador("Juan", 1, 5000, "Desarrollo","Java");
        Desarrollador desarrollador2 = new Desarrollador("Rodrigo", 2, 5000, "Desarrollo","Java");
        Desarrollador desarrollador3 = new Desarrollador("Manuel", 3, 5000, "Desarrollo","Java");

        List<Desarrollador> equipo = Arrays.asList(desarrollador1, desarrollador2,desarrollador3);
